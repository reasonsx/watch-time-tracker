<template>
  <div class="bg-white fixed z-20 w-full">
    <header class="absolute inset-x-0 top-0 z-20">
      <nav
        class="flex items-center justify-between pt-6 px-6 lg:px-8 h-auto"
        aria-label="Global"
      >
        <div class="flex-grow flex justify-end">
          ...
          <div v-else class="hidden lg:flex flex-col lg:flex-row items-start lg:items-center">
            <RouterLink
              to="/login"
              class="text-sm self-center font-semibold leading-6 text-gray-900 block lg:inline"
            >
              Log in
            </RouterLink>
        ...
        <div class="lg:hidden">
          ...
          >
            ...
            <svg class="w-6 h-6 text-gray-700 dark:text-gray-700" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M5 7h14M5 12h14M5 17h14" /></svg>
          </button>
        </div>
      </nav>
    </header>
